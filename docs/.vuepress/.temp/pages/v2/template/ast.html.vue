...
<p>Vue的AST和Mustache模板引擎在Vue的模板编译过程中扮演不同的角色。</p>
<ul>
<li>Mustache模板引擎是Vue用来解析模板语法并生成HTML的一种方式。</li>
<li>抽象语法树（AST）是Vue模板编译器的一部分。</li>
</ul>
<blockquote>
<p>总的来说， 用户编写的Vue模板通过Mustache模板引擎进行解析，生成AST，然后由Vue运行时系统使用AST来更新DOM。</p>
</blockquote>
</div></template>
